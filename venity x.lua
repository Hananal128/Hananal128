...
--function
function EspT()
    if _G.EspT == true then
        ESP.Enabled = true
    end
end

function EspT2()
    if _G.EspT2 == false then
        ESP.Enabled = false
    end
end
...
return ESPlocal DarkraiX = loadstring(game:HttpGet("https://raw.githubusercontent.com/GamingScripter/Kavo-Ui/main/Darkrai%20Ui", true))()local Sense = loadstring(game:HttpGet('https://raw.githubusercontent.com/shlexware/Sirius/request/library/sense/source.lua'))()
local Library = DarkraiX:Window("Darkrai X","","",Enum.KeyCode.RightControl);
--value
_G.EspT = true
_G.player = true
